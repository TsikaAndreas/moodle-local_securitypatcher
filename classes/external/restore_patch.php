...
/**
 * External function restore_patch for local_codepatcher.
 *
...
/**
 * External class restore_patch for local_codepatcher.
 *
 * @package   local_codepatcher
 * @copyright 2023 onwards Andrei-Robert Țîcă <andreastsika@gmail.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class restore_patch extends external_api {
    ...
    /**
     * Restore a code patch code by reverting the code changes.
     *
     * @param int $patchid
     * @return array
     */
    public static function execute(int $patchid): array {
        ...
        require_capability('local/codepatcher:restorepatch', $context);
